...
{
    public class FicVmRhCatPersonasDatosAdicionalesDetalle : FicViewModelBase
    {
        private rh_cat_personas_datos_adicionales Fic_rh_cat_personas_datos_adicionales_Item;
        ...
        public FicVmRhCatPersonasDatosAdicionalesDetalle(
        ...
        {
            get { return Fic_rh_cat_personas_datos_adicionales_Item; }
            set
            {
                Fic_rh_cat_personas_datos_adicionales_Item = value;

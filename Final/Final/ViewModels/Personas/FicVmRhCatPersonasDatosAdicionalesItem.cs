...
{
    public class FicVmRhCatPersonasDatosAdicionalesItem : FicViewModelBase
    {
        private rh_cat_personas_datos_adicionales Fic_Zt_rh_cat_personas_datos_adicionales_Item;
        ...
        public FicVmRhCatPersonasDatosAdicionalesItem(
        ...
        public rh_cat_personas_datos_adicionales Item
        {
            get { return Fic_Zt_rh_cat_personas_datos_adicionales_Item; }
            set
            {
                Fic_Zt_rh_cat_personas_datos_adicionales_Item = value;
        ...
        {
            var FicLoZt_inventarios = FicPaNavigationContext as rh_cat_personas_datos_adicionales;
        ...
        {
            await FicLoSrvCatPersonas.FicMetInsertNewRhCatPersonasDatosAdicionales(Item);
            FicLoSrvNavigationCatPersonas.FicMetNavigateBack();
        }

        private async void DeleteCommandExecute()
        {
            await FicLoSrvCatPersonas.FicMetRemoveRhCatPersonasDatosAdicionales(Item);
            FicLoSrvNavigationCatPersonas.FicMetNavigateBack();
        }

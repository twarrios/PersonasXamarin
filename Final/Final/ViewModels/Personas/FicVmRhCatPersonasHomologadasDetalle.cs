...
{
   public  class FicVmRhCatPersonasHomologadasDetalle : FicViewModelBase
    {
        private rh_cat_personas_homologadas Fic_rh_cat_personas_homologadas_Item;
        ...
        public FicVmRhCatPersonasHomologadasDetalle(
        ...
        {
            get { return Fic_rh_cat_personas_homologadas_Item; }
            set
            {
                Fic_rh_cat_personas_homologadas_Item = value;

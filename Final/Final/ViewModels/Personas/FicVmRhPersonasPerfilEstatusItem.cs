...
{
    public class FicVmRhPersonasPerfilEstatusItem : FicViewModelBase
    {
        private rh_personas_perfil_estatus Fic_Zt_rh_personas_perfil_estatus_Item;
        ...
        public FicVmRhPersonasPerfilEstatusItem(
        ...
        {
            get { return Fic_Zt_rh_personas_perfil_estatus_Item; }
            set
            {
                Fic_Zt_rh_personas_perfil_estatus_Item = value;

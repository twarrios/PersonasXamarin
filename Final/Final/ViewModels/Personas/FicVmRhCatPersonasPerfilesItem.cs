...
{
    public class FicVmRhCatPersonasPerfilesItem : FicViewModelBase
    {
        private rh_cat_personas_perfiles Fic_Zt_rh_cat_personas_perfiles_Item;
        ...
        public FicVmRhCatPersonasPerfilesItem(
        ...
        {
            get { return Fic_Zt_rh_cat_personas_perfiles_Item; }
            set
            {
                Fic_Zt_rh_cat_personas_perfiles_Item = value;
